...
@section('content')
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1>User Profile <small> <a href="{{URL::route('admin.users.index')}}" class="btn btn-default">back to list</a></small></h1>
        <ol class="breadcrumb">
          ...
          <div class="col-md-3">
            ...
            <div class="box box-primary">
              <div class="box-body box-profile">
                <img class="profile-user-img img-responsive img-circle" src="{{asset('admin/img/user4-128x128.jpg')}}" alt="User profile picture">
                <h3 class="profile-username text-center">{{$user->name}}</h3>
                <p class="text-center">e: <small>{{$user->email}}</small></p>
            ...
            <div class="nav-tabs-custom">
              ...
              <div class="tab-content">
                <div class="active tab-pane" id="activity">
                  ...
                  <div class="post">
                    <div class='user-block'>
                      <img class='img-circle img-bordered-sm' src="{{asset('admin/img/user6-128x128.jpg')}}" alt='user image'>
                      <span class='username'>
                        <a href="#">Adam Jones</a>
                        <a href='#' class='pull-right btn-box-tool'><i class='fa fa-times'></i></a>
                      </span>
