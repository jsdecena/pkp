    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active">Edit a supplier</li>
        </ol>
      </section>
          ...
          <div class="col-md-12">
            ...
            <div class="box box-primary">
              <div class="box-header with-border">
                ...
                <!-- form start -->
                {!!Form::open(array('url'=> URL::route('admin.suppliers.update', $supplier->id), 'method' => 'put', 'files' => true))!!}
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <img src="{{asset("uploads/$supplier->cover")}}" alt="" width="80" height="80" /> <br />
