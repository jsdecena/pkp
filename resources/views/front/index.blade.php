...
<head>
    ...
    <link rel="stylesheet" href="{{asset('http://fonts.googleapis.com/css?family=Montserrat:400,700')}}" type='text/css'>
...
<script type="text/javascript" src="{{asset('http://maps.google.com/maps/api/js?sensor=false&amp;libraries=places')}}"></script>
...
<!--[if lte IE 9]>
<script type="text/javascript" src="{{asset('assets/js/ie-scripts.js')}}"></script>
<![endif]-->

<script>
    var _latitude = 14.554729000000002;
    var _longitude = 121.02444519999999;
